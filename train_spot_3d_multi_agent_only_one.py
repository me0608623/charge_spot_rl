...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "spot_only_one_spot"
        ...
        self.phase1_spot_batch = 250000
        self.phase1_goal_batch = 30000
        self.phase3_spot_batch = 250000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["num_spot"] = 1  # 降低數量為了讓 spot 爬樓梯有價值
        ...
        self.phase_config["spot_min_speed_x"] = -0.85
        ...
        self.phase_config["spot_max_speed_y"] = 0.8
    ...
    def rl_env_all_config(self):
        env_config = dict(
            name="spot_3d",  # this don't change
            env=self.phase_config,
            trainer = dict(
                num_envs = self.num_envs,
                train_batch_size = self.train_batch_size,
                num_episodes = int(self.env_train_times * self.train_batch_size / self.phase_config["episode_length"] + 0.999),
            ),
