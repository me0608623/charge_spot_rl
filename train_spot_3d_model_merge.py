...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "spot_model_merge"
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.wandb_config['spot_model'] = [512, 1024, 512, 1024, 512, 192]
        self.wandb_config['spot_policy_network'] = []
        self.wandb_config['spot_critic_network'] = []
