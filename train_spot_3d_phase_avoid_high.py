...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "multi_phase_spot_avoid_obs_reward_high"
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["spot_penalty_hit"] = -90.0  # 為了上樓梯降低沒用，動態障礙物避障效果會很差，一下就死了
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name ='PHASE_2:v180')
