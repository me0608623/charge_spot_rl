...
class Spot_Env():
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.phase_config = dict(
            ...
            preprocess_info_weight = [1.0, 1.0, 1.0, 0.7, 0.7, 0.7, 0]
        )
        ...
        if PHASE == 1:
            ...
            self.phase_config["spot_penalty_hit"] = -20.0
            ...
            self.phase_config["floor_width_bias"] = 7.5 
        ...
        self.wandb_config['spot_preprocess_model_lr'] = 0.0005
