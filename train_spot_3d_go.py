...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "go_robot_dog"
        ...
        self.phase1_spot_batch = 40000
        self.phase1_goal_batch = 20000
        self.phase3_spot_batch = 80000
        self.phase3_goal_batch = 25000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.phase_config = dict(
            ...
            spot_size_bias = 0.2,
            spot_head_distance = 0.40,
            spot_ass_distance = 0.45,
            obs_size_rand = 0.0,
