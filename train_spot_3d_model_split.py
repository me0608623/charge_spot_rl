...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "spot_model_split"
        ...
        self.phase1_spot_batch = 60000
        self.phase1_goal_batch = 30000
        self.phase3_spot_batch = 85000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.phase_config["spot_min_speed_x"] = -0.85  # 0.85 is to small
        ...
        self.phase_config["spot_max_speed_y"] = 0.8  # 0.8 is to small
        ...
        self.wandb_config['spot_model_version'] = 'v2'  #'BN'
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_1:v191')
