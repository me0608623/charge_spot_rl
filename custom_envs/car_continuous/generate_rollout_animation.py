...
def generate_tag_env_rollout_animation(
    ...
    init_num_goal = env.num_agents - env.num_car - env.num_wall - env.num_people 
    ...
    def _get_label(timestep, n_goals_alive, init_n_goals):
        ...
        line3 = "goal Left:".ljust(14) + pct_goals_alive
    ...
    label = ax.text(
        ...
        0,
        0.02,
        _get_label(0, init_num_goal, init_num_goal).lower(),
    )
    ...
    def animate(i):
        ...
        n_goals_alive = episode_states["still_in_the_game"][i].sum() - env.num_car- env.num_wall - env.num_people 
        label.set_text(_get_label(i, n_goals_alive, init_num_goal).lower())
