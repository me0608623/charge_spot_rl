  ...
  __device__ void CudaTagContinuousGenerateObservation(
    ...
    if (kThisAgentId < kNumAgents) {
      ...
      for (int idx = 0; idx < min(num_valid_other_agents, kNumOtherAgentsObserved); idx++) {
        ...
        obs_arr[kThisAgentIdxOffset + 17 + 2 * kNumOtherAgentsObserved + idx] = static_cast<float>(0);
        ...
        obs_arr[kThisAgentIdxOffset + 17 + 5 * kNumOtherAgentsObserved + idx] = static_cast<float>(agent_sizes);
      }
