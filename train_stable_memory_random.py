...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "memory_10_env_random_half_spot"
        ...
        self.phase6_goal_batch = 110000
        self.phase8_spot_batch = 300000
        self.phase8_goal_batch = 110000
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_2:v192' )
