...
import random
import shutil
from custom_envs.spot_3dIn.spot_3dIn import Spot_3d
...
class Spot_Env():
    def __init__(self):
        ...
        self.phase1_spot_batch = 65000
        self.phase1_goal_batch = 30000
        self.phase3_spot_batch = 120000
        self.phase3_goal_batch = 60000
        self.phase5_spot_batch = 100000
        self.phase5_goal_batch = 60000
        self.phase6_spot_batch = 150000
        self.phase6_goal_batch = 60000
        self.phase8_spot_batch = 150000
        self.phase8_goal_batch = 60000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["reward_on_floor"] = 30.0
            ...
            #self.phase_config["goals_reward_speed"] = 0.02
            ...
            self.phase_config["num_obstacle"] = 9
            self.phase_config["num_stairs"] = 3
            self.phase_config["rl_fps"] = 3
            ...
            self.phase_config["rl_fps"] = 3
            self.phase_config["goal_size"] = 0.29
            self.phase_config["reward_on_floor"] = 40.0
            self.phase_config["floor_width_bias"] = 6.5
            self.phase_config["spot_reward_get_goal"] = 200.0
            self.phase_config["spot_reward_on_floor"] = 15.0
            self.phase_config["spot_penalty_hit"] = -60.0
            ...
            self.train_goal_num_goal = 12
            self.phase_config["num_spot"] = 3
            self.phase_config["num_goals"] = 16
            self.phase_config["num_obstacle"] = 11
            self.phase_config["num_stairs"] = 3
            self.phase_config["rl_fps"] = 3
            ...
            self.phase_config["floor_width_bias"] = 6.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -90.0
            self.phase_config["stairs_weight_rand"] = 2.5
            self.phase_config["obs_size_rand"] = 0.2
            self.phase_config["obstacle_speed_rate_with_spot"] = 0.95
            rl_env_times = 150
        elif PHASE == 6:
            self.train_spot_batch_size = self.phase6_spot_batch
            self.train_goal_batch_size = self.phase6_goal_batch
            self.train_goal_num_spot = 1
            self.train_goal_num_goal = 12
            rl_env_times = 200
            self.spot_times_train_env = False
            ...
            self.phase_config["spot_reward_get_goal"] = 200.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -180.0 
            self.phase_config["stairs_weight_rand"] = 2.5
            ...
            self.phase_config["spot_reward_get_goal"] = 200.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -350.0
            self.phase_config["stairs_weight_rand"] = 2.5
            self.phase_config["obs_size_rand"] = 0.3
            self.phase_config["obstacle_speed_rate_with_spot"] = 1.05
        else: 
            ...
            self.phase_config["spot_reward_get_goal"] = 200.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -50.0 * self.PHASE
            self.phase_config["stairs_weight_rand"] = 2.5
            self.phase_config["obs_size_rand"] = 0.3
            self.phase_config["obstacle_speed_rate_with_spot"] = 1.05
        ...
        self.wandb_config['spot_model'] = [512]
        self.wandb_config['spot_policy_network'] = [256, 128, 256, 512]
        self.wandb_config['spot_critic_network'] = [256, 128, 256, 512, 512]
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_7:v14')
