...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "merge_607_banch_reward_change"
        self.wandb_columns = ["state", "video", "weight", "PreTrain", "PHASE", "Get Goals Probability", "Total Goal", "Hit the obstacle times"]
        self.notes = 'reward_hit_add,env_times_low,num_goal_add, train_goal_change'
        ...
        self.phase3_spot_batch = 130000
        self.phase3_goal_batch = 70000
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_2:v188')
