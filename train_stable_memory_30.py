...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "memory_30_goal_gamma_high"
        self.wandb_columns = ["state", "video", "weight", "PreTrain", "PHASE", "Get Goals Probability", "Total Goal", "Hit the obstacle times"]
        self.notes = None #'at last train to phase 4，expected goal loss will reduce'
        self.rl_env_versioin = 'RL_Env_v18'
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["goals_reward_step"] = 0.5
