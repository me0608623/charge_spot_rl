...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "agent_spot_goal_large"
        ...
        self.phase1_spot_batch = 45000
        self.phase1_goal_batch = 20000
        self.phase3_spot_batch = 65000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["num_spot"] = 9
            self.phase_config["num_goals"] = 30  # 太多不行
            ...
            self.phase_config["num_spot"] = 6  # 降低數量為了讓 spot 爬樓梯有價值
            self.phase_config["num_goals"] = 32  # 降低數量為了讓 spot 爬樓梯
            ...
            self.phase_config["num_goals"] = 32
            self.phase_config["num_obstacle"] = 9
