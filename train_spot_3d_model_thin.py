...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "spot_model_thin"
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.wandb_config['spot_model'] = [256, 512, 256]
        self.wandb_config['spot_policy_network'] = [256, 128, 64]
        self.wandb_config['spot_critic_network'] = [256, 128, 32]
