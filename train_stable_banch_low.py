...
class Spot_Env():
    def __init__(self):
        ...
        self.phase1_spot_batch = 6500
        self.phase1_goal_batch = 3000
        ...
        self.phase8_spot_batch = 300000
        self.phase8_goal_batch = 30000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["spot_reward_get_goal"] = 200.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -240
            self.phase_config["stairs_weight_rand"] = 2.5
            self.phase_config["obs_size_rand"] = 0.3
            self.phase_config["obstacle_speed_rate_with_spot"] = 1.05
        else: 
        ...
        self.wandb_config['spot_model'] = [128, 128, 32]
        self.wandb_config['spot_policy_network'] = [256, 256, 512]
        self.wandb_config['spot_critic_network'] = [256, 256, 512, 512]
        self.wandb_config['memory_dim'] = 10
