...
class Spot_Env():
    def __init__(self):
        ...
        self.phase2_spot_batch = 110000
        self.phase2_goal_batch = 35000
        self.phase3_spot_batch = 140000
        self.phase3_goal_batch = 110000
        self.phase5_spot_batch = 120000
        self.phase5_goal_batch = 110000

        self.phase6_spot_batch = 200000
        self.phase6_goal_batch = 120000
        self.phase7_spot_batch = 350000
        self.phase7_goal_batch = 110000

        self.phase8_spot_batch = 350000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.phase_config = dict(
            ...
            obs_size_rand = 0.0,
            goals_reward_step = 0.8,  # hit wall
        ...
        if PHASE == 1:
            ...
            self.phase_config["spot_reward_get_goal"] = 40.0
            ...
            self.phase_config["rl_fps"] = 3
            self.phase_config["goal_size"] = 0.29
            self.phase_config["reward_on_floor"] = 50.0
            self.phase_config["floor_width_bias"] = 6.5
            self.phase_config["spot_reward_get_goal"] = 40.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -14.0
            ...
            self.phase_config["rl_fps"] = 3
            self.phase_config["goal_size"] = 0.29
            self.phase_config["reward_on_floor"] = 60.0
            self.phase_config["floor_width_bias"] = 6.5
            self.phase_config["spot_reward_get_goal"] = 40.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            ...
            self.phase_config["reward_on_floor"] = 70.0
