...
class Spot_Env():
    def __init__(self):
        ...
        self.phase7_spot_batch = 190000
        self.phase7_goal_batch = 120000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.wandb_config['rnn_layer'] = 2
        self.wandb_config['rnn_layer_type'] = 'LSTM'
