...
class Spot_Env():
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.wandb_config['spot_random_map'] = self.spot_random_map
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name=  'PHASE_2:v187')
