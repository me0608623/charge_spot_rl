...
class FullyConnected(nn.Module):
    ...
    def __init__(
        ...
        policy_input_dims = [fc_dims[-1]] + policy_network[:-1]
        ...
        for idx, act_space in enumerate(action_space):
            ...
            if num_policy_layers == 0: policy_heads[idx] = nn.Linear(fc_dims[-1], act_space)
        ...
        critic_input_dims = [fc_dims[-1]] + critic_network[:-1]
