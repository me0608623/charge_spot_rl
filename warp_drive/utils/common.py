...
def get_default_env_directory(env_name):
    envs = {
        ...
        "CarContinuous":  f"{get_project_root()}"
        f"/custom_envs/car_continuous/car_continuous_step.cu",
        "SagContinuous": f"{get_project_root()}"
        f"/custom_envs/tag_continuous/Sag_continuous_step.cu",
        "DoubleCar": f"{get_project_root()}"
        f"/custom_envs/train_double_car/Double_Car_step.cu",
        "FinalCar": f"{get_project_root()}"
        f"/custom_envs/final_car/final_car_step.cu",
        "Spot_3d": f"{get_project_root()}"
        f"/custom_envs/spot_3d/spot_3d_step.cu",
        "Spot_3dDis": f"{get_project_root()}"
        f"/custom_envs/spot_3dDis/spot_3dDis_step.cu",
        "New_Car": f"{get_project_root()}"
        f"/custom_envs/new_car/new_car_step.cu",
        "Spot_3dIn": f"{get_project_root()}"
        f"/custom_envs/spot_3dIn/spot_3dIn_step.cu",
        "Spot_3dDouble": f"{get_project_root()}"
        f"/custom_envs/spot_3dDouble/spot_3d_Double_step.cu",
        "Spot_3dMerge": f"{get_project_root()}"
        f"/custom_envs/spot_3dMerge/spot_3dMerge_step.cu",
        "Spot_3dState": f"{get_project_root()}"
        f"/custom_envs/spot_3dState/spot_3dState_step.cu",
        "Spot_3dModule": f"{get_project_root()}"
        f"/custom_envs/spot_3dmodule/spot_3dmodule_step.cu",
        "Spot_3dInLayer": f"{get_project_root()}"
        f"/custom_envs/spot_3dInLayer/spot_3dInLayer_step.cu"
    }
