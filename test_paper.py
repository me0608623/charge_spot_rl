...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "why_multi_task"
    ...
    def replace_old_file(self, wandb_path):
        ...
        #python_code_path = "./custom_envs/" + change_dir + "/spot_3dIn.py"
        ...
        now_python_path =  "./custom_envs/" + env_dir + "/spot_3d_step.cu"
        reg_python_path = "./custom_envs/" + reg_dir + "/spot_3d_step.cu"
        python_code_path = self.search_files_with_keywords(wandb_path, keywords = ['cuda_code'])
        shutil.copy2(now_python_path, reg_python_path)
        shutil.copy2(python_code_path, now_python_path)

        now_model_path =  "./custom_envs/fully_connected.py"
        reg_model_path = "./custom_envs/" + reg_dir + "/fully_connected.py"
        model_code_path = self.search_files_with_keywords(wandb_path, keywords = ['model_code'])
        shutil.copy2(now_model_path, reg_model_path)
        #hutil.copy2(model_code_path, now_model_path)
    ...
    def test(self,time_id, artifact_version, Start_Testing_type = 1, End_test_type = 2 ,test_num_time = 5, model_connect = None):
        ...
        for Testing_type_ in range(5):
            ...
            self.phase_config['num_obstacle'] = 0
            ...
            avoid_idx = 215
            avoid_seed = []
            #run_time = [30, 35, 62, 63, 98, 127, 150, 162, 296]
