...
import random
import shutil
from custom_envs.spot_3dMerge.spot_3dMerge import Spot_3d
...
class Spot_Env():
    def __init__(self):
        ...
        self.phase3_spot_batch = 92000
        self.phase3_goal_batch = 35000
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        if PHASE == 1:
            ...
            self.phase_config["spot_penalty_hit"] = -70.0  # 為了上樓梯降低沒用，動態障礙物避障效果會很差，一下就死了
            ...
            self.phase_config["num_spot"] = 3
            self.phase_config["num_goals"] = 16
            self.phase_config["num_obstacle"] = 11  # 11 已經非常多了別再加了 
            self.phase_config["num_stairs"] = 4
            self.phase_config["rl_fps"] = 3
            self.phase_config["goal_size"] = 0.29
            self.phase_config["reward_on_floor"] = 40.0
            ...
            self.phase_config["obstacle_speed_rate_with_spot"] = 1.0
            rl_env_times = 100
            self.train_goal_fix_spot_model = False
        elif PHASE == 5:
            self.train_spot_batch_size = self.phase3_spot_batch
            ...
            self.phase_config["spot_penalty_hit"] = -90.0
            self.phase_config["stairs_weight_rand"] = 2
            ...
            self.train_goal_num_spot = 1
            self.phase_config["num_spot"] = 3
            self.phase_config["num_goals"] = 12
            self.phase_config["num_obstacle"] = 11
            self.phase_config["num_stairs"] = 4
            self.phase_config["rl_fps"] = 3
            self.phase_config["goal_size"] = 0.28
            ...
            self.phase_config["floor_width_bias"] = 6.0
            self.phase_config["spot_reward_on_floor"] = 0.0
            self.phase_config["spot_penalty_hit"] = -15.0 * self.PHASE
            self.phase_config["stairs_weight_rand"] = 2
            self.phase_config["obs_size_rand"] = 0.4
            self.phase_config["obstacle_speed_rate_with_spot"] = 1.2
            rl_env_times = 100
            self.train_goal_fix_spot_model = False
    ...
    def log_all_data_to_wandb(self):
        ...
        python_code_path = "custom_envs/spot_3dMerge/spot_3dMerge.py"
        cuda_code_path = "custom_envs/spot_3dMerge/spot_3dMerge_step.cu"
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_1:v230')
