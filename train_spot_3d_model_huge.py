...
class Spot_Env():
    def __init__(self):
        ...
        self.results_dir_ = "spot_model_huge"
    ...
    def Calculate_PHASE_Parameter(self, PHASE = 1, old_config = None):
        ...
        self.wandb_config['spot_model'] = [512, 1024, 512]
        self.wandb_config['spot_policy_network'] = [512, 256, 128]
        self.wandb_config['spot_critic_network'] = [512, 256, 64]
...
if __name__ == "__main__":
    spot_env = Spot_Env()
    spot_env.train(download_weight_artifact_name = 'PHASE_2:v140')
